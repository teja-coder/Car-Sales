...
<div class="card-columns">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text"><b>Model: </b> <%=rs.getString("model")%> <br><b>Price: </b>Rs. <%=rs.getString("price")%> <br><b>Mileage: </b><%=rs.getString("mileage")%> kmpl<br/><b>Date: </b> <%=rs.getString("dt")%> <br></p>
      <a href="cancelappointment.jsp?model=<%=rs.getString("model")%>&price=<%=rs.getString("price")%>&mileage=<%=rs.getString("mileage")%>&date=<%=rs.getString("dt")%>&brand=<%=rs.getString("brand")%>"><button type="button" class="btn btn-outline-danger">Cancel Appointment</button></a>
